clear all;
clc;
load('input_test_another.mat')
load('input_train_another.mat')
load('output_test_another.mat')
load('output_train_another.mat')
...
X_trans =tanh(predict(Theta_pretrained(1:length(Theta_pretrained)-1),X));
num_labels = 1;
